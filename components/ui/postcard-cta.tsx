...
export function PostcardCTA({
  postcardImage = "/pharmaceutical-laboratory-scientist.jpg",
  postcardAlt = "Rex Biotech Pharmaceutical Services",
  ...
  return (
    <div className="min-h-[600px] flex items-center justify-center px-4 py-16 bg-background">
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="text-center max-w-2xl">
          <h2 className="text-4xl md:text-5xl font-doto mb-6 text-balance leading-tight">{heading}</h2>
          <p className="text-muted-foreground text-base md:text-lg mb-10 font-sans">{subtext}</p>
          <Button asChild className="rounded-lg px-6 py-3 font-sans bg-primary hover:bg-primary/90">
