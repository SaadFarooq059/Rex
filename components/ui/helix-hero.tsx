...
const Scene: React.FC = () => {
  return (
    ...
    >
      <hemisphereLight color={"#fff9e6"} groundColor={"#ffffff"} intensity={2} />
...
export const HelixHero: React.FC<HeroProps> = ({ title, description }) => {
  return (
    <section className="relative h-screen w-full font-sans tracking-tight text-gray-900 bg-white overflow-hidden">
      ...
      {/* Gradient overlays */}
      <div className="absolute bg-gradient-to-b from-transparent to-white/40 h-1/2 md:h-1/3 w-full bottom-0 pointer-events-none" />
      <div className="absolute bg-gradient-to-b from-white/40 to-transparent h-1/2 md:h-1/3 w-full top-0 pointer-events-none" />
    </section>
  )
}
